...
echo "3. Set up CI/CD using: ./scripts/setup-cicd.ps1 -WorkloadName \"$WORKLOAD_NAME\" -ResourceGroupName \"$WORKLOAD_NAME-01\" -SubscriptionId \"your-subscription-id\""
echo "4. Customize the UI and API for your specific needs"
echo "5. Run 'npm install' to install dependencies"
echo "6. Run 'npm run start:devServer' to start development"
echo ""
echo "CI/CD Setup:"
echo "- Azure DevOps: Use azure-pipelines.yml"
echo "- GitHub Actions: Use .github/workflows/deploy.yml"
echo "- Local Development: Use swa-cli.config.json"
